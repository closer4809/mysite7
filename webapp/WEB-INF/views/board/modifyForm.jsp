					...
					<div id="modifyForm">
						<form action="${pageContext.request.contextPath }/board/modify" method="get">
							...
							<div class="form-group">
								<span class="form-text">작성자</span>${boardVo.name} <span class="form-value"></span>
							</div>

							<!-- 조회수 -->
							<div class="form-group">
								<span class="form-text">조회수</span>${boardVo.hit} <span class="form-value"></span>
							</div>

							<!-- 작성일 -->
							<div class="form-group">
								<span class="form-text">작성일</span>${boardVo.regDate} <span class="form-value"></span>
							</div>
